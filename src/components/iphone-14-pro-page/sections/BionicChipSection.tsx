...
export default function BionicChipSection() {
  ...
  return (
    <div
      ...
      style={{ display: "flex", justifyContent: "center", alignItems: "center", width: "90vw", color: "#cecece" }}
    >
      <div>
      ...
      <div>
        <svg
          ...
          style={{
            position: "absolute",
            zIndex: 5,
            transform: `translateX(calc(${percent * maxTransform * 3}px - 66%)) scale(3) rotate(${percent * 45}deg) `,
            filter: " blur(50px)",
          }}
        >
          <path
